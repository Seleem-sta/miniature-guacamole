...
export const config = {
  ...
  authJwtSecret: required('AUTH_JWT_SECRET', 'dev-only-change-me'),
  bootstrapAdminEmail: required('ADMIN_EMAIL', ''),
  bootstrapAdminPassword: required('ADMIN_PASSWORD', ''),
  bootstrapAdminName: required('ADMIN_NAME', 'Platform Admin'),
  entraTenantId: required('ENTRA_TENANT_ID', ''),
  entraClientId: required('ENTRA_CLIENT_ID', ''),
  entraAdminEmails: required('ENTRA_ADMIN_EMAILS', ''),
